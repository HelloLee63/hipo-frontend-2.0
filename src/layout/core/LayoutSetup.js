...
export class LayoutSetup {
  ...
  static initLayout(config) {
    ...
    // document.body.style.backgroundImage = `url(${toAbsoluteUrl('/media/images/background-image.png')})`
    document.body.style.backgroundImage = `url(${toAbsoluteUrl('/media/patterns/bj.jpg')})`
